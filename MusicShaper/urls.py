...
urlpatterns = [
    ...
    path('project/<int:proj_id>/patterns',
         views.patterns_list, name='patterns'),
    path('project/<int:proj_id>/patterns/new',
         views.new_pattern, name='new_pattern'),
    path('project/<int:proj_id>/patterns/<int:pat_id>',
         views.pattern_editor, name='pattern_editor'),
